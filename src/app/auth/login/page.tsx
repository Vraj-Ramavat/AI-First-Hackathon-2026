    ...
    <div className="min-h-screen bg-base flex flex-col justify-center py-12 px-6 sm:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="text-center text-2xl font-display font-bold text-text-primary tracking-tight">
          Welcome back to Kirana Intelligence
        </h2>
        ...
        <div className="bg-surface/80 backdrop-blur-md p-8 rounded-3xl hairline-all shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-base border border-white/10 rounded-xl pl-11 pr-4 py-3 text-sm text-text-primary placeholder:text-text-secondary/50 focus:outline-none focus:border-accent transition-colors"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 rounded-xl bg-accent hover:bg-accent-hover text-text-primary font-semibold text-sm transition-all shadow-lg shadow-accent/10 flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {loading ? (
